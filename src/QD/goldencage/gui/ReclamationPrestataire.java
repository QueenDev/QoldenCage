 ...
 * @author Shift
 */
public class ReclamationPrestataire extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReclamationPrestataire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
