 ...
 * @author Shift
 */
public class LireReclamationClient extends javax.swing.JFrame {

    /**
     * Creates new form LireReclamationClient
     */
    public LireReclamationClient() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LireReclamationClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LireReclamationClient().setVisible(true);
            }
        });
    }
